...
export default function Root() {
  ...
  return (
    <>
      ...
      <Section className="bg-violet-600 font-eyecatcher text-center">
        <h1 className="mb-2 text-4xl" >Want to receive?</h1>
        <p className="text-lg" >You'll need to create an account.</p>
        <p className="text-lg mb-4" >You can share invite links for your fans to send letters.</p>

        <button hidden={isSigningUp} onClick={() => setIsSigningUp(!isSigningUp)} className="bg-transparent border-2 border-white rounded p-1 px-4">Sign Up</button>
        <SignUpForm hidden={!isSigningUp} /> 
      </Section>
      ...
      <Section className="bg-pink-500 font-eyecatcher text-center">
        <h1 className="mb-2 text-4xl" >Want to send?</h1>
        <p className="text-lg" >You don't need an account to send letters.</p>
        <p className="text-lg mb-4" >You will need their username, or an invite link.</p>

        <button hidden={isSending} onClick={() => setIsSending(!isSending)} type="submit" className="bg-transparent border-2 border-white rounded p-1 px-4">Send a Letter!</button>
        <UsernameForm hidden={!isSending} />
      </Section>
      ...
      <Section className="bg-amber-400 font-eyecatcher text-center">
