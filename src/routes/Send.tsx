...
export default function Send() {
  ...
  return (
    <>
      <Section className="font-eyecatcher text-3xl">Send a Letter</Section>
      <div className="font-poppins text-lg text-center mb-12">
      ...
      <SendForm hidden={letterSent} onSend={onSend} />
      <p hidden={!letterSent} className="font-eyecatcher text-2xl bg-pink-500 text-center">Letter sent! :)</p>
